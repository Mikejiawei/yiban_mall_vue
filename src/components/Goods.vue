...
<div class="accessory-list-wrap">
    <div class="accessory-list col-4">
        ...
        <li v-for="(good,index) in goodsList" :key='index' >
            ...
            <router-link :to="{path:'/CheckOrder',query:{name:good.name,price:good.price}}"><cube-button :primary="true" :inline="true">立即购买</cube-button></router-link>
...
methods: {
    _getGoods(){
        ...
        this.goodsList = this.data[0].goods
        this.hotList = this.data[1].goods
